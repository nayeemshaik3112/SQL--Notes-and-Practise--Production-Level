...
EXISTS returns TRUE/FALSE, not rows. It stops as soon as it finds the first matching order (efficient). The subquery is correlated: it uses u.user_id from the outer query.
------------------------------------------------------------------
NOT EXISTS
