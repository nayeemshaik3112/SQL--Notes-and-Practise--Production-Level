...
lets say we have 2 tables with name
...
Union will do - spiderman, thor, ironman
...
The full row, position-by-position.
------------------------------------------------------------------------------
UNION ALL
...
same example we will get for UNION ALL -> spiderman, spiderman, thor, ironman
--------------------------------------------------------------------
Feature	        UNION	                        UNION ALL
--------------------------------------------------------------------
Duplicates	    Removes duplicates	            Keeps duplicates
Performance	    Slower (due to deduplication)	Faster (no deduplication)
Use Case	    When unique records are required	When all records are needed
--------------------------------------------------------------------
